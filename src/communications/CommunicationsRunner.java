...
public class CommunicationsRunner {
  ...
  public static void main(String[] args) {
    // new Phone() напистаь нельзя, Phone - это интерфейс
    ...
    // при объявлении типа переменных можно использовать интерфейсы, как и обстрактные классы.
    // Java про эту переменную будет знать только то,что описано в её типе:
